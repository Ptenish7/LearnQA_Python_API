...
class TestUserAuth:
    ...
    def test_auth_user(self):
        ...
        assert self.user_id_from_auth_method == user_id_from_check_method, "User id from auth method is not equal to user id from check"
    ...
    def test_negative_auth_check(self, condition):
        ...
        assert user_id_in_check_method == 0, f"User is authorized with condition {condition}"